...
export const models: Array<OpenRouterModel> = [
  ...
  },
  {
    ...
    canonical_slug: 'mistral/ministral-8b-2410',
    hugging_face_id: 'mistralai/Ministral-8B-Instruct-2410',
  ...
  },
  {
    ...
    canonical_slug: 'qwen/qwen3-vl-4b-instruct',
    hugging_face_id: 'Qwen/Qwen3-VL-4B-Instruct',
  ...
  },
  {
    ...
    canonical_slug: 'minimax/minimax-m1-80k',
    hugging_face_id: 'MiniMaxAI/MiniMax-M1-80k',
    name: 'MiniMax: MiniMax-M1-80k',
    created: 1750194204,
    description:
      'MiniMax-M1-80k is a large-scale, open-weight reasoning model designed for extended context and high-efficiency inference. MiniMax-M1-80k has a 80k token thinking budget. It leverages a hybrid Mixture-of-Experts (MoE) architecture paired with a custom "lightning attention" mechanism, allowing it to process long sequences—up to 1 million tokens—while maintaining competitive FLOP efficiency. With 456 billion total parameters and 45.9B active per token, this variant is optimized for complex, multi-step reasoning tasks.\n\nTrained via a custom reinforcement learning pipeline (CISPO), M1 excels in long-context understanding, software engineering, agentic tool use, and mathematical reasoning. Benchmarks show strong performance across FullStackBench, SWE-bench, MATH, GPQA, and TAU-Bench, often outperforming other open models like DeepSeek R1 and Qwen3-235B.',
    context_length: 1000000,
    architecture: {
      modality: 'text->text',
      input_modalities: ['text'],
